...
import Problema_2.Service.Toys;
        ...
        do {
            ...
            switch (opc){
                case "1":{
                    ...
                    cosa.save(new Toy_Dto(id,name,category,price,amount));
                }
                case "2":{
                    System.out.println("~~~~~ List ~~~~~");
                    List<Toy_Dto> Toys = cosa.findAll();
                    if (!Toys.isEmpty()){
                ...
                case "3":{
                    ...
                    Toy_Dto existingToy = cosa.findById(idEdit);
                ...
                case "5":{
                    ...
                    int totalToys= cosa.findAll().stream().mapToInt(Toy_Dto::getExistingQuantity).sum();
